...
stability are straight forward. The proof of soundness is more involved, and
...
defined as follows.
\begin{align*}
  & \_\lift\_      : (\sigma : \Tms\ \Gamma\ \Delta) \to (A:\Ty) \to
                        \Tms\ (\Gamma,A[\sigma])\ (\Delta,A) \\
  & \sigma \lift A = (\sigma \circ \pi_1\,\id) , (_{[\circ]*}\pi_2\,\id)
\end{align*}
...
The corresponding definitions and proofs are typically straight forward, and we
