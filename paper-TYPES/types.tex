...
In definitions and lemmas, any free variable is implicitly universally
quantified, and its type can be inferred from the context, and the name
conventions.
...
\end{lemma}
\begin{proof}
  By simultaneous induction on the definition of the evaluation relation.
\end{proof}
