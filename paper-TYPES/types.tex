...
constructors to values and normal forms, and add the elimination principles to
...
Another equally interesting extension would be to replace the abstract universe $\U$,
which contains no closed terms, with a more useful universe equipped with type
constructors.
