...
until a normal form is reached. Termination and confluence ensure the correctness
of the definition. Soundness also follows from confluence, while completeness
and stability are immediate. See for instance~\cite{girard1989proofs}
...
variants of the lambda-calculus. For instance, termination is problematic for the
lambda-calculus with explicit substitutions~\cite{mellies1995explicit}, and the
